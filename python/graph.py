...
class Graph:
    ...
    def depthFirstSearch(self, s):
        ...
        The Depth First Search can locate a path more quickly, which may not be the shortest path. 
        Recursive algorithm.
    ...
    def breadthFirstSearch(self, s):
        ...
        """
        self.pred = [-1]*len(self.vertices)
        self.dist = [-1]*len(self.vertices)
        self.color = [0]*len(self.vertices)     # 0 is white

        self.color[s] = 1                       # 1 is gray
        self.dist[s] = 0
