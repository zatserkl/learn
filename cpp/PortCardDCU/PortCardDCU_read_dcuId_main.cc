...
to compile:
g++ PortCardDCU.cc PortCardDCU_read_dcuId_main.cc
*/
...
main()
{
  ...
  fname << "xdaqjcPID15965-with_dcuId.log";
  ...
  unsigned dcuId, fecBoardId, mfecId, ccuId, ccuChannelId, mode, Vaa, Vdd, rtd2, rtd3, aoh, Vpc, Vbg, ts;
