...
Address::Address(): fecBoardId_(0), mfecId_(0), ccuId_(0), ccuChannelId_(0) {}
Address::Address(std::string portcardName, unsigned fecBoardId, unsigned mfecId, unsigned ccuId, unsigned ccuChannelId):
  portcardName_(portcardName), fecBoardId_(fecBoardId), mfecId_(mfecId), ccuId_(ccuId), ccuChannelId_(ccuChannelId)
{}
Address::Address(const Address& address):
  portcardName_(address.portcardName_), fecBoardId_(address.fecBoardId_), mfecId_(address.mfecId_), ccuId_(address.ccuId_), ccuChannelId_(address.ccuChannelId_)
{}
